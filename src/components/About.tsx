const getImage = () => {
    ...
    img!.setAttribute("src", `/public/assets/switch/${num}.png`);
    //
}
...
const About = () => {
    return (
        <div id="about">
            <br/> 
            <img id="games" onClick={() => getImage()} src="/public/assets/switch/1.png" alt="Nintendo Switch and Game Boy made in Blender by me." />
