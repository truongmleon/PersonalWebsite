...
const Current = () => {
    return (
        <section data-aos="fade-right" id="current">
            ...
            <ul id="current-list">
                <li className="blurb-me">Building a vintage math book collection</li>
                <li className="blurb-me">Assembling Gundam (children)</li>
                ...
                <li className="blurb-me">Cardistry. I like learning 2 handed cuts and backdrop</li>
                ...
                <li className="blurb-me">Replaying GTA V, finishing The Outer Worlds</li>
