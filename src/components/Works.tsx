    ...
    return (
        <article>
            ...
            <section id="projects">
                ...
                <Project image={"Waves.png"} title={"AP Physics Video"} link={"https://github.com/truongmleon/Playground/tree/small-projects/AP%20Physics%201%3A%20Video%20Project"}/>
                <Project image={"KeyClub.png"} title={"Key Club Website"} link={"https://github.com/truongmleon/Key-Club-Website"}/>
